Shader "Ciconia Studio/CS_Glass/URP/Glass"
{
	Properties
	{
		...
		[Space(15)][Header(Global Properties________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________)][Space(10)]_TilingX("Tiling X", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 unpack2 = UnpackNormalScale( tex2D( _BumpMap, ( appendResult14_g25 + appendResult13_g25 ) ), _BumpScale );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float clampResult45 = clamp( (( _Invert )?( ( 1.0 - fresnelNode25 ) ):( fresnelNode25 )) , 0.0 , 1.0 );
				float AlbedoA250 = tex2DNode76.a;
				float2 uv_MetallicGlossMap = IN.ase_texcoord4.xyz.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float2 break26_g24 = uv_MetallicGlossMap;
				float2 appendResult14_g24 = (float2(( break26_g24.x * GlobalTilingX281 ) , ( break26_g24.y * GlobalTilingY282 )));
				float2 appendResult13_g24 = (float2(( break26_g24.x + GlobalOffsetX541 ) , ( break26_g24.y + GlobalOffsetY540 )));
				float4 tex2DNode123 = tex2D( _MetallicGlossMap, ( appendResult14_g24 + appendResult13_g24 ) );
